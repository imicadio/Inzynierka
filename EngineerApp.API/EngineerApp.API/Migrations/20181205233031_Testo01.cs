        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DietPlans_AspNetUsers_TrainerDietId",
                        column: x => x.TrainerDietId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DietPlans_AspNetUsers_UserDietId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pupils_AspNetUsers_PupilId",
                        column: x => x.PupilId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pupils_AspNetUsers_TrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DietDayId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DietDetails_DietDays_DietDayId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeMeasure = table.Column<string>(nullable: true),
                    DietDetailId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DietProducts_DietDetails_DietDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietDetails_DietDayId",
                table: "DietDetails",
                column: "DietDayId");

            migrationBuilder.CreateIndex(
                name: "IX_DietPlans_TrainerDietId",
                table: "DietPlans",
                column: "TrainerDietId");

            migrationBuilder.CreateIndex(
                name: "IX_DietPlans_UserDietId",
                table: "DietPlans",
                column: "UserDietId");

            migrationBuilder.CreateIndex(
                name: "IX_DietProducts_DietDetailId",
                table: "DietProducts",
                column: "DietDetailId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pupils_PupilId",
                table: "Pupils",
                column: "PupilId",
                unique: true,
                filter: "[PupilId] IS NOT NULL");

...
@Component({
  ...
  templateUrl: './calf-list.component.html',
  styleUrls: ['./calf-list.component.css']
})
export class CalfListComponent implements OnInit {
  ...
  public loadData() {
    ...
    .pipe(
      ...
      switchMap(() => {
        ...
        return this.dashboardService.calfList(this.authService.decodedToken.nameid, this.listQuery);
      }),
      map(data => {         
  ...
  deleteSurvey(id: number) {
    this.dashboardService.deleteCalf(id, this.authService.decodedToken.nameid).subscribe(()=>{

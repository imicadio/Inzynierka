...
@Component({
  selector: 'app-biceps-list1',
  templateUrl: './biceps-list.component1.html',
  styleUrls: ['./biceps-list.component1.css']
})
export class BicepsListComponent1 implements OnInit {
  ...
  public loadBiceps() {
    ...
    .pipe(
      ...
      switchMap(() => {
        ...
        return this.dashboardService.bicepsList(this.userId, this.listQuery);
      }),
      map(data => {         

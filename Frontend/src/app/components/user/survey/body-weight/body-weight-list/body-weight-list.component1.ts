...
@Component({
  selector: 'app-body-weight-list1',
  templateUrl: './body-weight-list.component1.html',
  styleUrls: ['./body-weight-list.component1.css']
})
export class BodyWeightListComponent1 implements OnInit {
  ...
  public loadData() {
    ...
    .pipe(
      ...
      switchMap(() => {
        ...
        return this.dashboardService.bodyWeightList(this.userId, this.listQuery);
      }),
      map(data => {         

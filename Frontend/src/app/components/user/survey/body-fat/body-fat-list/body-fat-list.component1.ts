...
@Component({
  selector: 'app-body-fat-list1',
  templateUrl: './body-fat-list.component1.html',
  styleUrls: ['./body-fat-list.component1.css']
})
export class BodyFatListComponent1 implements OnInit {
